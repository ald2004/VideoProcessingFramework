...
#CudaSharedMemoryRegionSet_from_decoder_contiguous(void* cuda_shm_handle, void* ptr_vpf, size_t offset,
#        size_t width,size_t height, size_t sPitch)
_ccudashm_shared_memory_region_set_from_decoder_contiguous = _ccudashm.CudaSharedMemoryRegionSet_from_decoder_contiguous
_ccudashm_shared_memory_region_set_from_decoder_contiguous.restype = c_int
_ccudashm_shared_memory_region_set_from_decoder_contiguous.argtypes = [
...
#CudaSharedMemoryRegionSet_from_decoder_contiguous(void* cuda_shm_handle, void* ptr_vpf, size_t offset,
#        size_t width,size_t height, size_t sPitch)
def get_cuda_memory_from_vpf_contiguous(cuda_shm_handle, ptr_vpf, width,height,sPitch):
    _raise_if_error(
        c_int(
            _ccudashm_shared_memory_region_set_from_decoder_contiguous(cuda_shm_handle, c_void_p(ptr_vpf), 0,0,
                                                                       width,height,sPitch)))
    return
